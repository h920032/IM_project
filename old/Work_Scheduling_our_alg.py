...
# GENE(): 切分並交配的函數 
#========================================================================#
def GENE(timelimit, available_sol, fix, generation, per_month_dir=tl.DIR_PER_MONTH):
	return gen.gene_alg(timelimit, available_sol, fix, generation, per_month_dir)
...
gene_result = GENE(timelimit,available_sol, fix, generation, per_month_dir=tl.DIR_PER_MONTH)
